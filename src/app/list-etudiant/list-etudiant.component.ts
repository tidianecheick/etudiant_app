...
const ELEMENT_DATA: PeriodicElement[] = [
  { id: 1, nom: 'jean', prenom: 'paul', email: 'jean@gmail.com',matricule:'H44MNJT' },
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, MatPaginatorModule, MatTableModule,MatIconModule],
  templateUrl: './list-etudiant.component.html',
  styleUrls: ['./list-etudiant.component.css']
})

export class ListEtudiantComponent implements AfterViewInit {
...
element: PeriodicElement | undefined;
  ...
  // 👉 ici, tu peux naviguer vers un formulaire ou ouvrir un modal
}
